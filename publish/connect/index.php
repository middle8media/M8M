...
<head>
  ...
  <script type="text/javascript">JotForm.init(function(){JotForm.description("input_5","");JotForm.alterTexts({required:"This field is required.",alphabetic:"This field can only contain letters",numeric:"This field can only contain numeric values",alphanumeric:"This field can only contain letters and numbers.",incompleteFields:"There are incomplete required fields. Please complete them.",uploadFilesize:"File size cannot be bigger than:",confirmClearForm:"Are you sure you want to clear the form",lessThan:"Your score should be less than",email:"Enter a valid e-mail address",uploadExtensions:"You can only upload following files:",pleaseWait:"Please wait..."})});</script>

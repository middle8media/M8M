        ...
        <h2>Connect with Us</h2>
            ...
            <input type="hidden" name="formID" value="12854524282">
              ...
              <style type="text/css">
                  ...
                  .twelve.column.details {
                    height: 180px;
                  }

                  .twelve.column.budget {
                    height: 123px;
                  }
...
/*                  .recaptchatable {
              ...
              <ul class="form-section">
                <div class="six column name" style="padding-left: 0px;">
                ...
                <div class="six column " style="padding: 0px;">
                ...
                <div class="six column email" style="padding-left: 0px;">
              ...
              <div id="formRight">
                <div class="twelve column details" style="padding: 0px;">
  ...
  <script type="text/javascript" src="../javascripts/prototype.js?v=3.0.1520"></script>
  <script type="text/javascript" src="../javascripts/protoplus.js?v=3.0.1520"></script>
  <script type="text/javascript" src="../javascripts/protoplus-ui.js?v=3.0.1520"></script>
  <script type="text/javascript" src="../javascripts/jotform.js?v=3.0.1520"></script>

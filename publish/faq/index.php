...
<head>
	...
	<div id=faq-page class=container>
      ...
      <?php include '../nav.php'; ?>
        ...
        <h2>Frequently Asked Questions</h2>
            ...
            <ol>
              <li><a href="#services" title=Service>What services do you offer?</a></li>
              <li><a href="#cost" title=Cost>How much will my project cost?</a></li>
              <li><a href="#time" title=Time>How long will my project take?</a></li>
 ...
 or via <a title="Skype.com" href="http://www.skype.com/" target=_blank>Skype</a> or <a title=Apple_Facetime href="http://www.apple.com/mac/facetime/" target=_blank>Facetime</a>. M8M will then email a project proposal, laying out the terms and cost in detail. Once agreed upon, M8M will provide a contract to be sign by both parties. After the contract is signed it's GO TIME!!! We require 50% payment to start. Then we work with you to gather content and deliverables. For a website this usually includes all images, logo files, web copy etc... basically anything in your posession that needs to go on your site, (don't worry we will walk you through it). After that we <span class="has-tip tip-top" title="design and develop for web, shoot and edit for video">produce</span> your project. We then present you with a 1st draft, requiring 25% payment upon delivery. After you provide us with your revisions, we produce the final draft, requiring the final 25% payment upon delivery. We are available for 5 working days after delivery of final draft for support and questions. Changes and revisions are not part of the 5 day support. Support is for fine tuning, questions, thoughts, troubleshooting etc... Any additional support, changes or admin are billed at $100 per hour.</p>
          ...
          <div data-spy=affix data-offset-top=305 id=aside class="four columns">
            ...
            <p><a href="mailto:info@middle8media.com?subject=Further Questions" "email Seth" class="small button">info@middle8media.com</a></p>
          </div>
